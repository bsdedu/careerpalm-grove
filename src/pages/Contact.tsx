...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us | TyrianAI</title>
        <meta name="description" content="Get in touch with TyrianAI for all your AI solution needs or inquiries. Our team is ready to help you." />
      </Helmet>
