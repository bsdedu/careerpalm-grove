      ...
      <div className="pt-24 pb-16">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold gradient-heading mb-6">About TyrianAI</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
              <div className="w-12 h-12 bg-tyrian-100 dark:bg-tyrian-900 rounded-full flex items-center justify-center mb-4">
                <span className="text-tyrian-600 dark:text-tyrian-400 text-xl font-bold">1</span>
              </div>
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Innovation</h3>
              <p className="text-gray-700 dark:text-gray-300">
                We constantly push the boundaries of what's possible, embracing new ideas and approaches to solve complex problems.
              </p>
            </div>
            
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
              <div className="w-12 h-12 bg-tyrian-100 dark:bg-tyrian-900 rounded-full flex items-center justify-center mb-4">
                <span className="text-tyrian-600 dark:text-tyrian-400 text-xl font-bold">2</span>
              </div>
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Integrity</h3>
              <p className="text-gray-700 dark:text-gray-300">
                We believe in ethical AI development and transparent practices that earn and maintain the trust of our clients and users.
              </p>
            </div>
            
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
              <div className="w-12 h-12 bg-tyrian-100 dark:bg-tyrian-900 rounded-full flex items-center justify-center mb-4">
                <span className="text-tyrian-600 dark:text-tyrian-400 text-xl font-bold">3</span>
              </div>
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Impact</h3>
              <p className="text-gray-700 dark:text-gray-300">
                We measure our success by the positive difference we make for our clients, their customers, and society at large.
              </p>
            </div>
          </div>
        </div>
