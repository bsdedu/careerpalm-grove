        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Leading the future with innovative AI solutions for businesses of all sizes.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@tyrianai.com" className="text-gray-600 hover:text-tyrian-600 dark:text-gray-400 dark:hover:text-tyrian-400">
                  info@tyrianai.com
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row md:justify-between items-center">
            <p className="text-gray-600 dark:text-gray-400 text-sm mb-4 md:mb-0">
              © {year} TyrianAI. All rights reserved.
            </p>
